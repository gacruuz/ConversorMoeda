...
public class Euro extends Application{
	...
	public void start(Stage window) throws Exception {
		...
		BackgroundImage myBI= new BackgroundImage(new Image("https://i.imgur.com/cRXzZWM.png",0,0,false,true),
	...
	private void botaoconverteracao(Stage window, TextField valor, Text texto1) {
		...
		try {
			...
			numero = (float) (numero * 0.22143);
			System.out.println("Euro: " + numero);
